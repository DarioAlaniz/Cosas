...
fpga -file D:/dario/fulgor/trabajo_final/workspace_ethernet/workspace_eth_BRAM_CDMA/test_CDMA/_ide/bitstream/eth1_wrapper.bit
configparams mdm-detect-bscan-mask 2
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2"  && jtag_cable_name =~ "Digilent JTAG-SMT1 210203367268A"} -index 0
rst -system
after 3000
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2"  && jtag_cable_name =~ "Digilent JTAG-SMT1 210203367268A"} -index 0
dow D:/dario/fulgor/trabajo_final/workspace_ethernet/workspace_eth_BRAM_CDMA/test_CDMA/Debug/test_CDMA.elf
bpadd -addr &main
